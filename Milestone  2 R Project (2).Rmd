...
### 12. HCAI healthcare:healthcare_data$total_costs_of_oshpd_projects:
Type:num
### 13. HCAI healthcare: healthcare_data$county:Type:chr
### 14. HCAI healthcare: healthcare_data$number_of_oshpd_projects 
:Type: num
...
### 1.HCAI: data_generation _date: from *** to date
### 2.HCAI: changed "total_cost_projects" from chr to numeric 
### 3. the remaining columns are in the apprpiate format.
