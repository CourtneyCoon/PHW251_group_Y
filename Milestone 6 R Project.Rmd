 ...
 **Discussion**
 Based upon our initial interpretation of data, we were able to differentiate between 8 counties that would benefit from greater healthcare funding: Amador, Calaveras, Tuolumne, Siskiyou, Plumas, Inyo, El Dorado, and Lake Counties. We initially established five criteria during our analysis:  chronic disease mortality, median age, population density, total spending on previous projects, and the percent of renter occupied units for each county. Based on our initial plot, we narrowed the above counties to 5, placing greater weight on mortality, median age, and population density. We placed less significance on renters ratio and project costs, with the assumption that higher median age is more likely to be owners rather than renters and cost allocation is more likely to be directed to those counties with greater healthcare needs. Based on the above, we narrowed our county allocation to the following: Tuolumne, Amador, Calaveras, Siskiyou, and Lake Counties. (5 counties). Both our plot and table are reflecting relatively similar data, other than one variation. In our analytical data table, Nevada county ranks higher than Siskiyou and Inyo (but this is not reflected in our plot) because although Nevada scored higher points, the higher score was established from a higher renters ratio and project costs, rather than the 3 criteria we emphasized.     
